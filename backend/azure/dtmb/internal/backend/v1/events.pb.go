...
type ActivityCompletedEvent struct {
	...
	RelatedSequenceNumber uint64 `protobuf:"varint,1,opt,name=related_sequence_number,json=relatedSequenceNumber,proto3" json:"related_sequence_number,omitempty"`
	Result                []byte `protobuf:"bytes,2,opt,name=result,proto3" json:"result,omitempty"`
}
...
func (x *ActivityCompletedEvent) GetRelatedSequenceNumber() uint64 {
	if x != nil {
...
func (x *ActivityFailedEvent) GetRelatedSequenceNumber() uint64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
func (x *SubOrchestrationInstanceCompletedEvent) GetRelatedSequenceNumber() uint64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
func (x *SubOrchestrationInstanceFailedEvent) GetRelatedSequenceNumber() uint64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
func (x *TimerExecutedEvent) GetRelatedSequenceNumber() uint64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
var file_backend_v1_events_proto_rawDesc = []byte{
	...
	0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x72,
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x53, 0x65,
