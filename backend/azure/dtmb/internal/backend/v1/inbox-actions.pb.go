...
func (x *ActivityCompletedInboxAction) GetRelatedSequenceNumber() uint32 {
	if x != nil {
...
func (x *ActivityFailedInboxAction) GetRelatedSequenceNumber() uint32 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
var file_backend_v1_inbox_actions_proto_rawDesc = []byte{
	...
	0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x72,
	...
	0x01, 0x28, 0x0d, 0x52, 0x15, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x53, 0x65, 0x71, 0x75,
