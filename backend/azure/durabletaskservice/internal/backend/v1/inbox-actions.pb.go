...
type InboxAction struct {
	...
	//	*InboxAction_ExecuteTimer
	//	*InboxAction_SubOrchestrationInstanceCompleted
	//	*InboxAction_SubOrchestrationInstanceFailed
...
func (x *InboxAction) GetExecuteTimer() *ExecuteTimerInboxAction {
	if x, ok := x.GetInboxActionType().(*InboxAction_ExecuteTimer); ok {
		return x.ExecuteTimer
	}
	return nil
}

func (x *InboxAction) GetSubOrchestrationInstanceCompleted() *SubOrchestrationInstanceCompletedInboxAction {
	if x, ok := x.GetInboxActionType().(*InboxAction_SubOrchestrationInstanceCompleted); ok {
		return x.SubOrchestrationInstanceCompleted
	}
	return nil
}

func (x *InboxAction) GetSubOrchestrationInstanceFailed() *SubOrchestrationInstanceFailedInboxAction {
	if x, ok := x.GetInboxActionType().(*InboxAction_SubOrchestrationInstanceFailed); ok {
...
type InboxAction_ExecuteTimer struct {
	ExecuteTimer *ExecuteTimerInboxAction `protobuf:"bytes,104,opt,name=execute_timer,json=executeTimer,proto3,oneof"`
}

type InboxAction_SubOrchestrationInstanceCompleted struct {
	SubOrchestrationInstanceCompleted *SubOrchestrationInstanceCompletedInboxAction `protobuf:"bytes,105,opt,name=sub_orchestration_instance_completed,json=subOrchestrationInstanceCompleted,proto3,oneof"`
}

type InboxAction_SubOrchestrationInstanceFailed struct {
	SubOrchestrationInstanceFailed *SubOrchestrationInstanceFailedInboxAction `protobuf:"bytes,106,opt,name=sub_orchestration_instance_failed,json=subOrchestrationInstanceFailed,proto3,oneof"`
}
...
func (*InboxAction_ExecuteTimer) isInboxAction_InboxActionType() {}

func (*InboxAction_SubOrchestrationInstanceCompleted) isInboxAction_InboxActionType() {}

func (*InboxAction_SubOrchestrationInstanceFailed) isInboxAction_InboxActionType() {}
...
type ExecuteTimerInboxAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ExecuteTimerInboxAction) Reset() {
	*x = ExecuteTimerInboxAction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_backend_v1_inbox_actions_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ExecuteTimerInboxAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecuteTimerInboxAction) ProtoMessage() {}

func (x *ExecuteTimerInboxAction) ProtoReflect() protoreflect.Message {
	mi := &file_backend_v1_inbox_actions_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecuteTimerInboxAction.ProtoReflect.Descriptor instead.
func (*ExecuteTimerInboxAction) Descriptor() ([]byte, []int) {
	return file_backend_v1_inbox_actions_proto_rawDescGZIP(), []int{5}
}

func (x *ExecuteTimerInboxAction) GetRelatedSequenceNumber() int64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
type SubOrchestrationInstanceCompletedInboxAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SubOrchestrationInstanceCompletedInboxAction) Reset() {
	*x = SubOrchestrationInstanceCompletedInboxAction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_backend_v1_inbox_actions_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SubOrchestrationInstanceCompletedInboxAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubOrchestrationInstanceCompletedInboxAction) ProtoMessage() {}

func (x *SubOrchestrationInstanceCompletedInboxAction) ProtoReflect() protoreflect.Message {
	mi := &file_backend_v1_inbox_actions_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubOrchestrationInstanceCompletedInboxAction.ProtoReflect.Descriptor instead.
func (*SubOrchestrationInstanceCompletedInboxAction) Descriptor() ([]byte, []int) {
	return file_backend_v1_inbox_actions_proto_rawDescGZIP(), []int{6}
}

func (x *SubOrchestrationInstanceCompletedInboxAction) GetRelatedSequenceNumber() int64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
func (x *SubOrchestrationInstanceCompletedInboxAction) GetResult() []byte {
	if x != nil {
		return x.Result
	}
	return nil
...
type SubOrchestrationInstanceFailedInboxAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SubOrchestrationInstanceFailedInboxAction) Reset() {
	*x = SubOrchestrationInstanceFailedInboxAction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_backend_v1_inbox_actions_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SubOrchestrationInstanceFailedInboxAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubOrchestrationInstanceFailedInboxAction) ProtoMessage() {}

func (x *SubOrchestrationInstanceFailedInboxAction) ProtoReflect() protoreflect.Message {
	mi := &file_backend_v1_inbox_actions_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubOrchestrationInstanceFailedInboxAction.ProtoReflect.Descriptor instead.
func (*SubOrchestrationInstanceFailedInboxAction) Descriptor() ([]byte, []int) {
	return file_backend_v1_inbox_actions_proto_rawDescGZIP(), []int{7}
}

func (x *SubOrchestrationInstanceFailedInboxAction) GetRelatedSequenceNumber() int64 {
	if x != nil {
		return x.RelatedSequenceNumber
	}
	return 0
...
func (x *SubOrchestrationInstanceFailedInboxAction) GetResult() []byte {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *SubOrchestrationInstanceFailedInboxAction) GetFailureDetails() *FailureDetails {
	if x != nil {
		return x.FailureDetails
	}
	return nil
...
var file_backend_v1_inbox_actions_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x05, 0x0a, 0x0b, 0x49,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xc5, 0x01,
	0x0a, 0x29, 0x53, 0x75, 0x62, 0x4f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64,
	0x49, 0x6e, 0x62, 0x6f, 0x78, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x36, 0x0a, 0x17, 0x72,
	0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x5f,
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x72, 0x65,
	...
	0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x48, 0x0a, 0x0f, 0x66,
	0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x03,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x61, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_backend_v1_inbox_actions_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_backend_v1_inbox_actions_proto_goTypes = []interface{}{
	...
	(*ExecuteTimerInboxAction)(nil),                      // 5: dtmb.backend.v1.ExecuteTimerInboxAction
	(*SubOrchestrationInstanceCompletedInboxAction)(nil), // 6: dtmb.backend.v1.SubOrchestrationInstanceCompletedInboxAction
	(*SubOrchestrationInstanceFailedInboxAction)(nil),    // 7: dtmb.backend.v1.SubOrchestrationInstanceFailedInboxAction
	(*Delay)(nil),              // 8: dtmb.backend.v1.Delay
	(*ParentInstanceInfo)(nil), // 9: dtmb.backend.v1.ParentInstanceInfo
	(*TraceContext)(nil),       // 10: dtmb.backend.v1.TraceContext
	(*FailureDetails)(nil),     // 11: dtmb.backend.v1.FailureDetails
}
var file_backend_v1_inbox_actions_proto_depIdxs = []int32{
	...
	5,  // 4: dtmb.backend.v1.InboxAction.execute_timer:type_name -> dtmb.backend.v1.ExecuteTimerInboxAction
	6,  // 5: dtmb.backend.v1.InboxAction.sub_orchestration_instance_completed:type_name -> dtmb.backend.v1.SubOrchestrationInstanceCompletedInboxAction
	7,  // 6: dtmb.backend.v1.InboxAction.sub_orchestration_instance_failed:type_name -> dtmb.backend.v1.SubOrchestrationInstanceFailedInboxAction
	8,  // 7: dtmb.backend.v1.CreateOrchestrationInboxAction.start_at:type_name -> dtmb.backend.v1.Delay
	9,  // 8: dtmb.backend.v1.CreateOrchestrationInboxAction.parent:type_name -> dtmb.backend.v1.ParentInstanceInfo
	10, // 9: dtmb.backend.v1.CreateOrchestrationInboxAction.trace_context:type_name -> dtmb.backend.v1.TraceContext
	11, // 10: dtmb.backend.v1.ActivityFailedInboxAction.failure_details:type_name -> dtmb.backend.v1.FailureDetails
	11, // 11: dtmb.backend.v1.SubOrchestrationInstanceFailedInboxAction.failure_details:type_name -> dtmb.backend.v1.FailureDetails
...
func file_backend_v1_inbox_actions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_backend_v1_inbox_actions_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecuteTimerInboxAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_backend_v1_inbox_actions_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubOrchestrationInstanceCompletedInboxAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_backend_v1_inbox_actions_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubOrchestrationInstanceFailedInboxAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_backend_v1_inbox_actions_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*InboxAction_ExecuteTimer)(nil),
		(*InboxAction_SubOrchestrationInstanceCompleted)(nil),
		(*InboxAction_SubOrchestrationInstanceFailed)(nil),
	}
	type x struct{}
