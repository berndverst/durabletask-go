...
type TerminateOrchestrationOrchestratorAction struct {
	...
	// Optional reason
	Reason []byte `protobuf:"bytes,10,opt,name=reason,proto3" json:"reason,omitempty"`
}
...
func (x *TerminateOrchestrationOrchestratorAction) GetReason() []byte {
	if x != nil {
		return x.Reason
	}
	return nil
...
var file_backend_v1_orchestrator_actions_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0x61, 0x5a, 0x36, 0x67,
