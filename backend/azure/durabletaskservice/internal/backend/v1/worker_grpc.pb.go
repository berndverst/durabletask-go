...
const (
	TaskHubWorker_Ping_FullMethodName                    = "/dtmb.backend.v1.TaskHubWorker/Ping"
	TaskHubWorker_Metadata_FullMethodName                = "/dtmb.backend.v1.TaskHubWorker/Metadata"
	TaskHubWorker_ConnectWorker_FullMethodName           = "/dtmb.backend.v1.TaskHubWorker/ConnectWorker"
	TaskHubWorker_GetOrchestrationHistory_FullMethodName = "/dtmb.backend.v1.TaskHubWorker/GetOrchestrationHistory"
)
...
func (c *taskHubWorkerClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubWorker_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskHubWorkerClient) Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*MetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubWorker_Metadata_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskHubWorkerClient) ConnectWorker(ctx context.Context, opts ...grpc.CallOption) (TaskHubWorker_ConnectWorkerClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskHubWorker_ServiceDesc.Streams[0], TaskHubWorker_ConnectWorker_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *taskHubWorkerClient) GetOrchestrationHistory(ctx context.Context, in *GetOrchestrationHistoryRequest, opts ...grpc.CallOption) (*GetOrchestrationHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubWorker_GetOrchestrationHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedTaskHubWorkerServer
...
// UnimplementedTaskHubWorkerServer should be embedded to have forward compatible implementations.
...
func _TaskHubWorker_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskHubWorker_Ping_FullMethodName,
	}
...
func _TaskHubWorker_Metadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskHubWorker_Metadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskHubWorker_GetOrchestrationHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskHubWorker_GetOrchestrationHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
